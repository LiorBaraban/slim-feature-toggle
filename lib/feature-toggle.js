const { APP_FEATURES } = require("../app-features");

// console.log(`Initializing Feature Toggler - Enabled features - ${[APP_FEATURES.ROOT_PDF_GENERATOR, ...process.env.ENABLED_FEATURES.split(',')]}`);
