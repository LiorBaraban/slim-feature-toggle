...
const isAppVersionEqualTo = (inputVersion) => {
  ...
  const appVersion = getPackageJsonVersion();
...
const getPackageJsonVersion = () => {
  require.main.require(`./package.json`);
  const { version: packageJsonVersion } = require.main.require(`./package.json`);
...
module.exports.getPackageJsonVersion = getPackageJsonVersion;